...
def get_dv(start = 20130101,end = 20180101): 
    ...
    #define
    factor_list  = ['alpha59','alpha112','alpha134','alpha191','ARTDays','BBIC','MassIndex']
...
from Tamplate import alpha59,alpha112,alpha134,alpha191,ARTDays,BBIC,MassIndex

for f in ['alpha59','alpha112','alpha134','alpha191','ARTDays','BBIC','MassIndex']:
