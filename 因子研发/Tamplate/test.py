...
def get_dv(start = 20130101,end = 20180101): 
    import jaqs_fxdayu
    ...
    #define
    factor_list  = ['sw1','volume','close_adj','float_mv','turnover','high_adj','low_adj','pb','pe']
    check_factor = ','.join(factor_list)
    
    dataview_folder = r'C:/data'
...
from Tamplate import smart_degree,ILLIQ,bias_std_turn_Nm,bias_turn_Nm,std_turn_Nm,high_r_std_Nm,hml_r_std_Nm,hpl_r_std_Nm,pb_industry,pe_industry

for f in ['smart_degree','ILLIQ','bias_std_turn_Nm','bias_turn_Nm','std_turn_Nm','high_r_std_Nm','hml_r_std_Nm','hpl_r_std_Nm','pb_industry','pe_industry']:
